    ...
    cards: [
      {
        ...
        formacao: [
          ...
          "Especialização em Cuidados Paliativos pelo Instituto Pallium",
          "Especialização em Neurointensivismo do Adulto pelo Hospital Sírio-Libanês",
        ],
        atuacao: [
          "Coordenadora do curso de Medicina da Florence",
          "Docente em disciplinas clínicas e de gestão em saúde",
        ],
      },
      {
        nome: "Marcos Pacheco",
        ...
        formacao: [
          "Doutorado e Mestrado em Políticas Públicas (UFMA)",
          "Graduação em Medicina",
          "Graduação em Direito",
          "Especialização em Saúde Coletiva",
        ],
        atuacao: [
          "Ex-Secretário de Estado da Saúde do Maranhão",
          "Ex-Secretário de Políticas Públicas do Maranhão",
          "Professor universitário",
          "Tutor do Programa Mais Médicos",
        ],
      },
      {
        nome: "Roclides Lima",
        ...
        formacao: [
          "Doutorado e Mestrado pela UNIFESP",
          "Especialização em Cirurgia Geral e do Aparelho Digestivo",
        ],
        atuacao: [
          "Cirurgião assistente e preceptor no HU-UFMA",
          "Atuação em diversos hospitais do Maranhão",
          "Pioneiro da cirurgia robótica no estado",
          "Já formou mais de 600 cirurgiões em videocirurgia e robótica",
        ],
      },
      {
        nome: "Savya Milhomem",
        ...
        formacao: [
          "Doutorado em Ciências pela USP (2012)",
          "Residência em Otorrinolaringologia",
          "Especialização em Zumbido",
          "Especialização em Medicina do Sono",
        ],
        atuacao: [
          "Professora Doutora Adjunta C3 da UFMA",
          "Coordenadora de Semestre do curso de Medicina da UFMA",
          "Atendimento clínico em Otorrinolaringologia",
        ],
      },
      {
        nome: "Yuri Nassar",
        ...
        atuacao: [
          ...
          "Atendimento clínico em Hematologia",
        ],
      },
      {
        ...
        formacao: [
          "Doutoranda em Medicina pela USP Ribeirão Preto",
          "Residência em Oftalmologia com Título de Especialista",
          "Fellowship em Plástica Ocular, Vias Lacrimais e Órbita",
        ],
        atuacao: [
          "Atendimento clínico em Oftalmologia",
          "Procedimentos de Plástica Ocular e Vias Lacrimais",
          "Pesquisa científica em Oftalmologia",
        ],
      },
    ],
  },
