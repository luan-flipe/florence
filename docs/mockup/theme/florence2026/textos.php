...
function florence2026_txt() {
	return array(
		...
		'sim_titulo'   => 'Fale com o time de admissões',
		'sim_sub'      => 'Deixe seu contato e a gente te ajuda a escolher o curso e a simular sua bolsa.',
		...
		'clinica_kicker' => 'Estrutura que atende a cidade',
			'clinica_h2'     => 'A Clínica-Escola atende a comunidade de São Luís.',
			'clinica_lead'   => 'Odontologia, ambulatório e análises clínicas abertos aos bairros vizinhos. É onde o estudante da Florence pratica desde cedo, cuidando de gente de verdade.',
			'clinica_cta'    => 'Conhecer a Clínica-Escola',
			'clinica_fotos'  => array(
