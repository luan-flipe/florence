...
function florence2026_txt() {
	return array(
		...
		'ways'         => array(
			array( 'Vestibular digital', 'Prova online, com data e horário flexíveis.' ),
			array( 'Nota do ENEM', 'Use a nota que você já tem.' ),
			array( 'Histórico escolar', 'Aproveite seu desempenho no ensino médio.' ),
			array( 'Transferência', 'Venha de outra instituição.' ),
			array( 'Segunda graduação', 'Para quem já tem diploma.' ),
			array( 'Volte a estudar', 'Retome de onde você parou.' ),
		),
