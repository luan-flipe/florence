...
import { CursoModal, type Curso } from "../curso-modal";
import { useCursoInteresse } from "../curso-interesse-context";
import type { UmbrellaConfig } from "../types";

interface CursosProps {
  cursos: UmbrellaConfig["cursos"];
}

export function Cursos({ cursos }: CursosProps) {
  const ref = useScrollReveal<HTMLElement>();
  const { subtitulo, grupos, eyebrow, titulo } = cursos;
