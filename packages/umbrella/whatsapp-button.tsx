interface WhatsappButtonProps {
  /** Numero internacional so digitos, ex "5598988630502". */
  numero: string;
  mensagem?: string;
}

/** Botao flutuante de WhatsApp (canto inferior direito). */
export function WhatsappButton({ numero, mensagem }: WhatsappButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.45)] transition-transform duration-300 hover:scale-105 active:scale-95"
    >
