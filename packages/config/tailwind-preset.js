/**
 * Preset Tailwind compartilhado — tokens da marca Florence.
 * Consumido pelos apps via `presets: [require("@florence/config/tailwind-preset")]`.
 * NÃO inclui `content` (cada app define seus próprios globs).
 */
